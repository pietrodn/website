...
|
u
[0-9a-fA-F]{4})`,name:`constant.character.escape.json.lines`},{match:`\\\\.`,name:`invalid.illegal.unrecognized-string-escape.json.lines`}]},value:{patterns:[{include:`#constant`},{include:`#number`},{include:`#string`},{include:`#array`},{include:`#object`},{include:`#comments`}]}},scopeName:`source.json.lines`})];export{e as default};