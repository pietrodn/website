var e=[Object.freeze({displayName:`DAX`,name:`dax`,patterns:[{include:`#comments`},{include:`#keywords`},{include:`#labels`},{include:`#parameters`},{include:`#strings`},{include:`#numbers`}],repository:{comments:{patterns:[{begin:`//`,captures:{0:{name:`punctuation.definition.comment.dax`}},end:`
...
=
`,name:`keyword.control.dax`}]},{match:`[_$[:alpha:]][_$[:alnum:]]*`,name:`variable.other.constant.dax`}]},strings:{begin:`"`,end:`"`,name:`string.quoted.double.dax`,patterns:[{match:`\\\\.`,name:`constant.character.escape.dax`}]}},scopeName:`source.dax`})];export{e as default};