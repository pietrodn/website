import{n as e}from"./rolldown-runtime-S-ySWqyJ.js";var t=e({default:()=>n}),n=[Object.freeze({displayName:`CSS`,name:`css`,patterns:[{include:`#comment-block`},{include:`#escapes`},{include:`#combinators`},{include:`#selector`},{include:`#at-rules`},{include:`#rule-list`}],repository:{"at-rules":{patterns:[{begin:`\\A(?:\\xEF\\xBB\\xBF)?(?i:(?=\\s*@charset\\b))`,end:`;|(?=$)`,endCaptures:{0:{name:`punctuation.terminator.rule.css`}},name:`meta.at-rule.charset.css`,patterns:[{captures:{1:{name:`invalid.illegal.not-lowercase.charset.css`},2:{name:`invalid.illegal.leading-whitespace.charset.css`},3:{name:`invalid.illegal.no-whitespace.charset.css`},4:{name:`invalid.illegal.whitespace.charset.css`},5:{name:`invalid.illegal.not-double-quoted.charset.css`},6:{name:`invalid.illegal.unclosed-string.charset.css`},7:{name:`invalid.illegal.unexpected-characters.charset.css`}},match:`(?x)
\\G
((?!@charset)@\\w+)
|
\\G(\\s+)
...
(?=[+~>\\s,.\\#|){:\\[]|/\\*|$)`,name:`entity.name.tag.css`},"unicode-range":{captures:{0:{name:`constant.other.unicode-range.css`},1:{name:`punctuation.separator.dash.unicode-range.css`}},match:`(?<![\\w-])[Uu]\\+[0-9A-Fa-f?]{1,6}(?:(-)[0-9A-Fa-f]{1,6})?(?![\\w-])`},url:{begin:`(?i)(?<![\\w@-])(url)(\\()`,beginCaptures:{1:{name:`support.function.url.css`},2:{name:`punctuation.section.function.begin.bracket.round.css`}},end:`\\)`,endCaptures:{0:{name:`punctuation.section.function.end.bracket.round.css`}},name:`meta.function.url.css`,patterns:[{match:`[^'")\\s]+`,name:`variable.parameter.url.css`},{include:`#string`},{include:`#comment-block`},{include:`#escapes`}]}},scopeName:`source.css`})];export{n,t};