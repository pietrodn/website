...
([-_[:alnum:]]+)
)`,beginCaptures:{1:{name:`punctuation.definition.tag.apex`},2:{name:`entity.name.tag.apex`},3:{name:`entity.name.tag.namespace.apex`},4:{name:`punctuation.separator.colon.apex`},5:{name:`entity.name.tag.localname.apex`}},end:`(/?>)`,endCaptures:{1:{name:`punctuation.definition.tag.apex`}},name:`meta.tag.apex`,patterns:[{include:`#xml-attribute`}]}},scopeName:`source.apex`})];export{e as default};