var e=[Object.freeze({displayName:`Dream Maker`,fileTypes:[`dm`,`dme`],foldingStartMarker:`(?x)
/\\*\\*(?!\\*)
...
|(?:icon|ref|[Rr]oman)(?=\\[)
|[s<>"n\\n \\[]
)`,name:`constant.character.escape.dm`},{match:`\\\\.`,name:`invalid.illegal.unknown-escape.dm`}]}},scopeName:`source.dm`})];export{e as default};