...
|
u
[0-9a-fA-F]{4})`,name:`constant.character.escape.json.comments`},{match:`\\\\.`,name:`invalid.illegal.unrecognized-string-escape.json.comments`}]},value:{patterns:[{include:`#constant`},{include:`#number`},{include:`#string`},{include:`#array`},{include:`#object`},{include:`#comments`}]}},scopeName:`source.json.comments`})];export{t as n,n as t};